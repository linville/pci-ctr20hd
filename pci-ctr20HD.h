/***************************************************************************
 Copyright (C) 2008  Warren J. Jasper <wjasper@tx.ncsu.edu>
 All rights reserved.
...
/* open modes */
#define CTR20HD_COUNTER    (0x2)
#define CTR20HD_FREQUENCY  (0x12)
...
#define C_5MHZ     0x0  // 5.0 MHz
#define C_1MHZ     0x1  // 1.0 MHz
#define C_10MHZ    0x2  // 10.0 MHz
#define EXTERNAL   0x3  // External
#define C_16_67MHZ 0x4  // 16.67 MHz
#define C_8_33MHZ  0x5  // 8.33 MHz
#define C_3_33MHZ  0x6  // 3.33 MHz
#define C_1_67MHZ  0x7  // 1.67 MHz
